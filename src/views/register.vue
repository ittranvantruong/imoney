        ...
        <div class="container mx-auto px-8">
            ...
            <form class="flex flex-col space-y-6" @submit.prevent="onSubmit">
                <div class="row">
                    <label class="flex flex-col" for="fullName">
                        ...
                        <input id="fullName" type="text" class="px-4 py-3 rounded-lg border mt-1 focus:border-blue-400 active:border-blue-400 focus-visible:border-blue-400" placeholder="Fullname" v-model="fullname"/>
                    </label>    
                </div>
                <div class="row">
            ...
            <div class="w-full text-center mt-6">
                ...
                <span class="ml-1 text-blue-700 font-bold">
                    <router-link :to="{ name: 'login', params: {}}" class="text-blue-700 semibold">Sign In</router-link>
                </span>
            </div>
        </div>
    </div>
